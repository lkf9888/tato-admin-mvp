  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 sm:gap-5 xl:grid-cols-2">
        {owners.map((owner) => (
          <article key={owner.id} className="rounded-lg border border-white/70 bg-white/90 p-4 shadow-sm sm:p-6">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
              <div className="min-w-0">
                <h3 className="font-serif text-xl text-slate-950 sm:text-3xl">{owner.name}</h3>
