...
import { getTaskStatusFromMiniProgram, serializeStaffMiniProgramTask } from "@/lib/staff-mini-program";
...
export async function PATCH(request: NextRequest, { params }: { params: Params }) {
  ...
  await logActivity({
    ...
    action: parsed.unassign ? "staff_task_unassigned_by_staff_app" : "staff_task_updated_by_staff_app",
