  ...
  return (
    <>
      <button
        ...
        className="rounded-md border border-rose-300 px-3 py-2 text-[12px] font-medium text-rose-700"
      >
        {deleteLabel}
      </button>
          ...
          <div className="w-full max-w-md rounded-lg border border-white/70 bg-white p-4 shadow-2xl">
            ...
            <div className="mt-4 flex gap-2">
              ...
              <form action="/api/share-links/delete" method="post" className="flex-1">
                ...
                <button className="w-full rounded-md bg-rose-600 px-3 py-2 text-[12px] font-medium text-white">
                  {confirmYesLabel}
                </button>
              </form>
            </div>
