...
export const calendarMessages = {
  en: {
    calendar: {
      ...
      pricesToggle: "Prices",
      pricesToggleHint: "Show what each day costs, and set it here.",
      priceLabel: "Price",
      priceSetAction: "Set",
      priceClearAction: "Reset",
      priceSavingAction: "Saving\u2026",
      selectionNeedsRun:
  ...
  zh: {
    calendar: {
      ...
      pricesToggle: "价格",
      pricesToggleHint: "显示每天的价格，并在这里改。",
      priceLabel: "价格",
      priceSetAction: "设置",
      priceClearAction: "恢复",
      priceSavingAction: "保存中…",
