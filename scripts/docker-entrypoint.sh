...
# Additive, idempotent DDL that has to land before the push below. Shared with
# CI, which runs this same script against a database built from the previously
# deployed schema -- see scripts/schema-predeploy.sh for what is in it and why.
